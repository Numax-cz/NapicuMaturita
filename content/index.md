...
- Rezistory: parametry, rozdělení, druhy, charakteristické vlastnosti, značení
- Kondenzátory: rozdělení, charakteristické vlastnosti, náhradní schémata, značení, využití
- Cívky: v elektrickém obvodu, vlastnosti, náhradní schémata, využití, feromagnetika
...
### 10. Vlastnosti, parametry a základní zapojení zesilovačů
- Rozdělení zesilovačů a jejich základní vlastnosti a základní parametry
- Nastavení a stabilizace pracovního bodu zesilovače
- Jednostupňový, vícestupňový zesilovač
- třídy zesilovačů
- zpětné vazby zesilovačů
...
- Aktivní filtry
### 13. Oscilátory a generátory nesinusových kmitů
- Podstata činnosti oscilátorů, základní parametry, vznik netlumených kmitů
- Zpětnovazební oscilátory, podmínky vzniku oscilací
- LC oscilátory s induktivní zpětnou vazbou
- RC oscilátory
- Generátory obdélníkových a trojúhelníkových kmitů
### 14. Bezdrátový přenos informací, sdělovací vedení, antény
- Vznik, vlastnosti elektromagnetickým vln
- Šíření elektromagnetickým vln prostorem
- Rozdělení elektromagnetických vln
- Vf vedení - náhradní schéma, vlnová impedance, šíření vln po vedení, impedanční přizpůsobení
- Typy vf vedení a jejich vlastnosti
- Druhy a vlastnosti antén
### 15. Analogové modulace, harmonická analýza
- Pojem a princip modulace, rozdělení modulací
- Amplitudová modulace - časové průběhy signálů, frekvenční spektra, vlastnosti
- Frekvenční a fázová modulace - časové průběhy signálů, frekvenční spektrum, vlastnosti
### 16. Diskrétní modulace v základním a přeneseném pásmu
- Nekódované modulace v základním pásmu PAM, PWM, PPM, PFM
- Kódované modulace PCM, DPCM, DM, ADM
- Diskrétní modulace s nosnými vlnami ASK, FSK, PSK
- Více stavové diskrétní modulace snosnými vlnami QPSK, M-QAM, OFDM
### 17. Optoelektronické komunikační systémy
- Výhody a problémy optoelektrických systémů
- Základní zapojení optického spoje, zdroje záření (LED a laserové diody), detektory záření (fotodiody)
- Optická přenosová cesta (optický kabel), výhody oproti metalickým kabelům, princip přenosu
- Navazovaní paprsku do optického vlákna, přenosové parametry optických vláken (měrný útlum, disperse)
- Typy optických vláken, spojování optických vláken
- Vlnový multiplex, optické zesilovače, typy vlnových multiplexerů
### 18. Měření elektrického proudu a napětí, zvyšování rozsahu voltmetru a ampérmetru
...
- Měření výkonu ve střídavém proudu
### 20. Analogový osciloskop, princip činnosti dle blokového schématu, způsoby měření
...
### 23. Prvky pro získání informací snímače 
- Blokové schéma a snímače
- Požadavky kladené na snímače
- Rozdělení snímačů
- SMART snímače, blokové schéma
- Unifikované signály
### 24. Akční prvky - pohony
- Definice akčního prvku, pohonu
- Blokové schéma a pohonu
- Rozdělení pohonů
- Příslušenství - přídavná zařízení pohonů
- Regulační orgán - rozdělení
### 25. Snímače
